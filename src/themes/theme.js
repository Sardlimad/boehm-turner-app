...
const theme = extendTheme({
  config: {
    initialColorMode: "light", // 'light' o 'dark'
    useSystemColorMode: true, // Si true, usa el tema del sistema operativo
  },
  styles: {
    global: (props) => ({
      body: {
  ...
  colors: {
    ...
    transparent: {
      50: `${blueBrand[50]}88`,
      100: `${blueBrand[100]}88`,
      200: `${blueBrand[200]}88`,
      300: `${blueBrand[300]}88`,
    },
    gray: {
      20: "#f9fafb",
      50: "#f7fafc",
